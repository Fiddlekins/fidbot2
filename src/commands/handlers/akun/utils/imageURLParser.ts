/**
 * Code copied from akun site code, parameter meanings deduced, basic TS added
 * @param e Input URL
 ...
 * @returns {*}
 */
export function imageURLParser(e: string | undefined, t?: number, n?: number, i?: string, r?: string): string | undefined {
  function a() {
